...
function LoginContent() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Refresh layout context by standard page reload, so getCurrentUser triggers
        ...
        <div className="ps5-plate-outer p-[3px]">
          <div className="ps5-plate-inner p-8 sm:p-10">
            ...
            <p className="text-center text-[11px] font-bold uppercase tracking-widest opacity-30 mb-10">
              Login to access your STUNET account
            </p>
            ...
            <form onSubmit={handleEmailLogin} className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center text-[10px] font-bold uppercase tracking-wider opacity-30 cursor-pointer hover:opacity-50 transition-opacity">
                  <input type="checkbox" className="mr-2 rounded border-white/20 bg-transparent text-blue-600 focus:ring-blue-500/50" />
                  Remember me
                </label>
                <Link href="/forgot-password" className="text-[10px] font-bold uppercase tracking-wider text-cyan-400 hover:text-cyan-300 transition-colors">
                  Forgot password?
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full ps5-btn !py-4 !text-sm disabled:opacity-50"
              >
